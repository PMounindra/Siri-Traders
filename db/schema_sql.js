// Full initial-schema SQL, generated via `npx drizzle-kit generate` from
// db/schema/*.js (see drizzle/0000_calm_callisto.sql — kept in sync with it).
// Embedded as a JS string (rather than read from disk at runtime) so it's
// guaranteed to be included in the Vercel serverless function bundle.
