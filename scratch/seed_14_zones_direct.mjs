...
const directUrl = 'postgresql://postgres.heskqectwuezbkfdlyez:Siritraders%401234@db.heskqectwuezbkfdlyez.supabase.co:5432/postgres';
...
async function run() {
  try {
    console.log('Connecting via direct DB host...');
    await sql`
