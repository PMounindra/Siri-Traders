...
const pooler5432Url = 'postgresql://postgres.heskqectwuezbkfdlyez:Siritraders%401234@aws-0-ap-southeast-2.pooler.supabase.com:5432/postgres';

const sql = postgres(pooler5432Url, { ssl: 'require', connect_timeout: 10 });
...
async function run() {
  try {
    console.log('Connecting via pooler 5432 host...');
    await sql`
